...
#for input:
#it is a 3*3 board, each cell is numbered from 1-9 row-wise
#first choose which turn you want, X or O
#and then depending on your turn input the cell number to enter your mark